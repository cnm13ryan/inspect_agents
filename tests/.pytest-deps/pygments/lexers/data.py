...
class YamlLexer(ExtendedRegexLexer):
    ...
    def save_indent(self, start=False):
        ...
        def callback(lexer, match, context):
            ...
            if text:
                yield match.start(), self, text
            if extra:
                yield match.start()+len(text), self.Error, extra
            context.pos = match.end()
        return callback

    def set_indent(self, implicit=False):
    ...
    def set_block_scalar_indent(self):
    ...
    def parse_block_scalar_empty_line(self, content_token_class):
        ...
        def callback(lexer, match, context):
            ...
            if (context.block_scalar_indent is None or
                ...
                yield match.start(), self, indentation
                yield (match.start()+context.block_scalar_indent,
                       content_token_class, content)
            context.pos = match.end()
        return callback

    def parse_block_scalar_indent(self):
    ...
    def parse_plain_scalar_indent(self):
