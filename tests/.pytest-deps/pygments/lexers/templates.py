...
class SmartyLexer(RegexLexer):
    ...
    def analyse_text(self):
        rv = 0.0
        if re.search(r'\{if\s+.*?\}.*?\{/if\}', self):
            rv += 0.15
        if re.search(r'\{include\s+file=.*?\}', self):
            rv += 0.15
        if re.search(r'\{foreach\s+.*?\}.*?\{/foreach\}', self):
            rv += 0.15
        if re.search(r'\{\$.*?\}', self):
            rv += 0.01
        return rv
...
class VelocityLexer(RegexLexer):
    ...
    def analyse_text(self):
        rv = 0.0
        if re.search(r'#\{?macro\}?\(.*?\).*?#\{?end\}?', self, re.DOTALL):
            rv += 0.25
        if re.search(r'#\{?if\}?\(.+?\).*?#\{?end\}?', self, re.DOTALL):
            rv += 0.15
        if re.search(r'#\{?foreach\}?\(.+?\).*?#\{?end\}?', self, re.DOTALL):
            rv += 0.15
...
class VelocityXmlLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = VelocityLexer.analyse_text(self) - 0.01
        if looks_like_xml(self):
            rv += 0.4
        return rv
...
class DjangoLexer(RegexLexer):
    ...
    def analyse_text(self):
        rv = 0.0
        if re.search(r'\{%\s*(block|extends)', self) is not None:
            rv += 0.4
        if re.search(r'\{%\s*if\s*.*?%\}', self) is not None:
            rv += 0.1
        if re.search(r'\{\{.*?\}\}', self) is not None:
            rv += 0.1
        return rv
...
class MasonLexer(RegexLexer):
    ...
    def analyse_text(self):
        result = 0.0
        if re.search(r'</%(class|doc|init)>', self) is not None:
            result = 1.0
        elif re.search(r'<&.+&>', self, re.DOTALL) is not None:
            result = 0.11
        return result
...
class HtmlGenshiLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        ...
        if re.search(r'\$\{.*?\}', self) is not None:
            rv += 0.2
        if re.search(r'py:(.*?)=["\']', self) is not None:
            rv += 0.2
        return rv + HtmlLexer.analyse_text(self) - 0.01
...
class GenshiLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        ...
        if re.search(r'py:(.*?)=["\']', self) is not None:
            rv += 0.2
        return rv + XmlLexer.analyse_text(self) - 0.01
...
class JavascriptGenshiLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return GenshiLexer.analyse_text(self) - 0.05
...
class RhtmlLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = ErbLexer.analyse_text(self) - 0.01
        if html_doctype_matches(self):
...
class CssErbLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return ErbLexer.analyse_text(self) - 0.05
...
class HtmlPhpLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = PhpLexer.analyse_text(self) - 0.01
        if html_doctype_matches(self):
            rv += 0.5
        return rv
...
class CssPhpLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return PhpLexer.analyse_text(self) - 0.05
...
class JavascriptPhpLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return PhpLexer.analyse_text(self)
...
class HtmlSmartyLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = SmartyLexer.analyse_text(self) - 0.01
        if html_doctype_matches(self):
            rv += 0.5
        return rv
...
class CssSmartyLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return SmartyLexer.analyse_text(self) - 0.05
...
class HtmlDjangoLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = DjangoLexer.analyse_text(self) - 0.01
        if html_doctype_matches(self):
            rv += 0.5
        return rv
...
class CssDjangoLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return DjangoLexer.analyse_text(self) - 0.05
...
class JspLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = JavaLexer.analyse_text(self) - 0.01
        if looks_like_xml(self):
            rv += 0.4
        if '<%' in self and '%>' in self:
            rv += 0.1
...
class EvoqueHtmlLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return EvoqueLexer.analyse_text(self)
...
class TeaTemplateLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = TeaLangLexer.analyse_text(self) - 0.01
        if looks_like_xml(self):
            rv += 0.4
        if '<%' in self and '%>' in self:
            rv += 0.1
...
class LassoHtmlLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = LassoLexer.analyse_text(self) - 0.01
        if html_doctype_matches(self):  # same as HTML lexer
            rv += 0.5
        return rv
...
class LassoCssLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = LassoLexer.analyse_text(self) - 0.05
        if re.search(r'\w+:[^;]+;', self):
            rv += 0.1
        if 'padding:' in self:
            rv += 0.1
        return rv
...
class SqlJinjaLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        rv = 0.0
        # dbt's ref function
        if re.search(r'\{\{\s*ref\(.*\)\s*\}\}', self):
            rv += 0.4
        # dbt's source function
        if re.search(r'\{\{\s*source\(.*\)\s*\}\}', self):
            rv += 0.25
        # Jinja macro
        if re.search(r'\{%-?\s*macro \w+\(.*\)\s*-?%\}', self):
            rv += 0.15
        return rv
