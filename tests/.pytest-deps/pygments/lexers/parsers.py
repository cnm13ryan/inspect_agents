...
class AntlrLexer(RegexLexer):
    ...
    def analyse_text(self):
        return re.search(r'^\s*grammar\s+[a-zA-Z0-9]+\s*;', self, re.M)
...
class AntlrCppLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return AntlrLexer.analyse_text(self) and \
            re.search(r'^\s*language\s*=\s*C\s*;', self, re.M)
...
class AntlrObjectiveCLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return AntlrLexer.analyse_text(self) and \
            re.search(r'^\s*language\s*=\s*ObjC\s*;', self)
...
class AntlrCSharpLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return AntlrLexer.analyse_text(self) and \
            re.search(r'^\s*language\s*=\s*CSharp2\s*;', self, re.M)
...
class AntlrPythonLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return AntlrLexer.analyse_text(self) and \
            re.search(r'^\s*language\s*=\s*Python\s*;', self, re.M)
...
class AntlrJavaLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        ...
        return AntlrLexer.analyse_text(self) and 0.9
...
class AntlrRubyLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return AntlrLexer.analyse_text(self) and \
            re.search(r'^\s*language\s*=\s*Ruby\s*;', self, re.M)
...
class AntlrPerlLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return AntlrLexer.analyse_text(self) and \
            re.search(r'^\s*language\s*=\s*Perl5\s*;', self, re.M)
...
class AntlrActionScriptLexer(DelegatingLexer):
    ...
    def analyse_text(self):
        return AntlrLexer.analyse_text(self) and \
            re.search(r'^\s*language\s*=\s*ActionScript\s*;', self, re.M)
