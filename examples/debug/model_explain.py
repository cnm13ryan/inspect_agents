...
Examples:
  uv run python examples/debug/model_explain.py --model openai/gpt-4o-mini --json
  uv run python examples/debug/model_explain.py --role coder
  uv run python examples/debug/model_explain.py --provider openai  # will error without OPENAI_API_KEY
